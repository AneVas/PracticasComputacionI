...
int main()
{
    ...
    {
        cout << "Operacion:";  //Al correr el codigo nos aparecia incompleta la palabra operación, por lo tanto quitamos el acento
        cin >> decision;
    }
...
array<float, LEN> SumarArreglos(array<float, LEN> arr1, array<float, LEN> arr2)
{
    ...
    //OJO. Recordemos que se añade el valor del resultado al arreglo principal y por eso retornamos a arr1
    return arr1;
}